...
int main()
{
    ...
    cout << "Type 'exit' to quit anytime." << endl;

    while (true)
    {

        cout << "Please enter a CC number to validate: " << endl;
        cin >> ccNumber;
        ...
        {
            cout << "CC number is of incorrect format " << endl;
            continue;
        }
        ...
        cout << (doubleEvenSum % 10 == 0 ? "Your CC number is Valid!" : " We are sorry!!! Your CC number is Invalid!") << endl;
        continue;
    }
    return 0;
}